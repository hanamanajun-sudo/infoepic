...
description: "틱톡에 관심이 있어서 몇번 보다 보니 역시 이것도 중독성있어서 계속 보게 되더라ㅎㄷㄷ 틱톡 영상 설명란이나 댓글에
  #FYP라는 정체불명의 해시태그가 엄청나게 도배되어 있는 것이 눈에 띄었다. 도대체 틱톡 FYP 뜻이 뭐길래 이렇게 다들 약속이나 한 듯이
  주루룩 달아놓는 걸까?"
pubDate: 2024-03-21
...
틱톡 영상에서 가장 흔하게 볼 수 있는 해시태그인 FYP는 영어 문장 '**For You Page<strong>'의 앞 글자를 딴 줄임말이다. 이를 우리말로 아주 직관적으로 번역하면 '당신을 위한 페이지', 즉 '</strong>추천 페이지**'라는 뜻이 된다.
...
따라서 자신의 영상이 누군가의 FYP 피드에 올라가느냐 마느냐에 따라 조회수가 고작 10회에서 멈출지, 아니면 1,000만 회가 넘어가는 이른바 '떡상'을 할지가 결정된다. 즉, #FYP 해시태그는 크리에이터들이 알고리즘에게 바치는 일종의 기도이자 조공인 셈이다.

## \#FYP 해시태그 노출 효과, 실제로 있을까?
...
\
결국 #FYP 태그의 진짜 가치는 '알고리즘을 속이는 꼼수'가 아니라, 틱톡이라는 플랫폼의 문화와 언어를 이해하고 있다는 신호에 가깝다. 마치 커뮤니티의 암호 같은 것. 태그 하나로 대박이 터지길 바라기보다는, 시청자가 끝까지 보고 싶은 콘텐츠를 만드는 것이 결국 알고리즘을 이기는 유일한 정답이라는 걸 데이터는 이미 증명하고 있다.
...
\
참고로 FYP처럼 플랫폼 고유의 추천 피드를 부르는 단어는 유튜브에도 있다. 유튜브의 경우 홈 화면 추천을 'Recommended'라고 부르며, 크리에이터들 사이에서는 'algorithm bait(알고리즘 미끼)' 전략이라는 말이 공공연하게 쓰인다. 플랫폼마다 이름은 달라도, 크리에이터들이 알고리즘의 눈에 들기 위해 안간힘을 쓴다는 사실은 어디서나 똑같다.
